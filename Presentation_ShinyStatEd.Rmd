...
## Impact of Technology on Teaching Introductory Statistics Concepts
...
## Shiny by RStudio
  ...
  - Easily customizable for any course
    ...
    - User interface file allows customization of layout
    - Server file allows programmer to set calculations
...
## Sampling Distribution for One Proportion {.smaller}
  ...
  - Enter values for inputs:
    ...
    - Sample size
    - Number of samples
  - Sample Distribution & Summary Statistics appear for sample generated from a binomial distribution with the user input values
...
## Confidence Intervals for One Sample Proportion {.smaller}
  - 20 samples are drawn from a binomial distribution with p = 0.5 and given sample size
  - Confidence intervals are calculated using the sample proportions
...
## Confidence Interval 
  ...
  - The relationship between confidence interval width and sample size apparent
  - The relationship between confidence interval width and confidence level easy to see
...
- Enter values of interest:
    ...
    - Sample Size
    - Number of samples
  - Sample Distribution & Summary Statistics appear drawn from a normal distribution with user set values
  - Sampling Distribution for a sample proportion and summary information appear
...
## Sampling Distribution for One Mean 
  ...
  - Focus on the difference between the Sample Distribution and Sampling Distribution
  - Describe the Sampling Distribution

    
## Sampling Distributions for Differences in Means and Proportions 

  - Enter values for each group and samples will be drawn from their respective distributions
  - Sample Distribution & Summary Statistics appear for each group
  - Sampling Distribution and summary information appear
...
## Sampling Distributions for Differences in Means and Proportions 
  ...
  - For these sections we focus on finding the sample statistics of interest
  - How the sampling distribution is created from the samples collected
  - Properties of the sampling distribution
  

## Correlation

  - This tab provides a quick visual representation of correlation
  - The scatterplot contains data simulated from a multivariate random normal distribution with the user input correlation value
      - Data generated with mean of 0, variance 1, and covariance set by the user input correlation value 
...
## Outlier Effects on Least Squares Lines 
  ...
  - See how different outliers affect the placement of the least squares line 
  


## Linear Regression Equation Exploration {.smaller}

  - Tab allows exploration of different intercept and slope values
    - Data generated from a multivaraite random normal distribution with X~N(0,1) and Y~N(0,1000) 
    - Covariance set to the user input slope value
  ...
  - User has the option to highlight the intercept with a red point
  
  - User also can add a visualization of the interpretation of the slope on the plot
  
  - Interpretations of the intercept and slope are output and update as the plot does
...
## Linear Regression Equation Exploration
 - Focus on properties of slope and intercept
 - See interpretations of slope and intercept 
 
 

## ANOVA 

- The ANOVA tab provides some visual representation of differences of 3 groups of data
